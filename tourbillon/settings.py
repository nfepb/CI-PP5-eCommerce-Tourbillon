"""
Django settings for tourbillon project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'f6&ri)ld47z=c$k#zdx^50j^@!8n3uji4!9t7v%ogra6m+ae54')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'DEVELOPMENT' in os.environ

ALLOWED_HOSTS = ['pp5-ecommerce-tourbillon.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'tourbillon.wsgi.application'
...
if "USE_AWS" in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = "pp5-ecommerce-tourbillon"
